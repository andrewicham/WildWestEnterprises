/*
    Filename: WildWestEnterprises.js
    Written by: Andrew Chambers
    Purpose: form with custom validation, utilizing jquery-ui plugin for styling
    Date: 12/8/2018
...
$(document).ready(function(){
    ...
    //added readonly="" on html page to prevent user input errors
    ...
    $.validator.setDefaults({
        ...
        *****/
        submitHandler: function() {
            //storing all checkbox and radio button values into variables
            var sOil = $("#snakeOil");
            var hat = $("#hats");
            var wag = $("#wagons");
            var sma = $("#small");
            ...
            //keyword stored into variable
            var keyword = $("#autocomplete").val();
            //personal information from form stored into variables
    ...
    $("#form1").validate({             
        ...
        messages: {
            ...
            customerTel: {
                ...
                minlength: $.validator.format("must be a {0} digit phone number"),
                maxlength: $.validator.format("Can't have more than {0} numbers")
            },
            customerMessage: {
                minlength: $.validator.format("Must have at least {0} characters")
            }
